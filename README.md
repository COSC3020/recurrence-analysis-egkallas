...
Analysing the pattern, the expression for this recurrence relation is: $T(n) = 3^iT(\frac{n}{3^i}) + \displaystyle\sum_{j=0}^n \frac{n^5}{3^{i+2}}  + n^5$<br>
...
$3^{\log_{3} n}  * T(1) + \displaystyle\sum_{j=0}^n \frac{n^5}{3^{(\log_{3} n) + 2}} + n^5$<br>
This simplifies to $n + \displaystyle\sum_{j=0}^n\frac{n^5}{n+2} + n^5$<br>
